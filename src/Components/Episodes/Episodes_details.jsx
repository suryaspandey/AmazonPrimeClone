...
export const Episodes_details = ({ imgdata, episodeNo }) => {
    ...
    return (
        ...
        >
            <div className="episode-img" style={{ position: "relative" }}>
                ...
                {isHovered && <BsPlayFill className="episode-playbtn" />}
            </div>
                ...
                <div className="episode-content">
                    ...
                    <div className="episode-details" style={{ color: "white" }}>
                        <h4 style={{ color: "#aaa" }}>
                            ...
                            elit. Aut porro amet, commodi, possimus voluptatum
                            molestiae magnam debitis veritatis alias molestias,
                            repellat nulla perspiciatis consectetur! Tenetur est
                            quia quis laborum tempore voluptatum dolor
                            voluptatem provident consectetur eius nostrum sit
                            fuga iure nobis, earum necessitatibus minima iste
                            adipisci in perspiciatis saepe atque.
                        </h4>
                    </div>
